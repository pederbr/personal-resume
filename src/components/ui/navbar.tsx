...
const Navbar = () => {
  ...
  return (
    <>
      <div className={`flex justify-between p-10 bg-background`}>
        ...
        <div className="flex items-center lg:hidden">{dropdown}</div>

        <div
          className={`flex-col lg:flex-row lg:flex space-x-4 items-center ${isOpen ? 'flex' : 'hidden'} lg:flex`}
        >
          <Link
            href="/about"
            className={`min-w-28 flex items-center px-2 py-2 rounded-md ${pathname === '/about' ? 'bg-primary-foreground' : ''}  `}
